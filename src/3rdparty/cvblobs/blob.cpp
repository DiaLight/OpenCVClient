...
- FUNCIONALITAT: Implementaciу de la classe CBlob
- AUTOR: Inspecta S.L.
MODIFICACIONS (Modificaciу, Autor, Data):
...
//! Indica si el blob estа buit ( no tй cap info associada )
...
- RESTRICCIONS:
	- 
- AUTOR: rborras
- DATA DE CREACIУ: 2008/04/30
- MODIFICACIУ: Data. Autor. Descripciу.
*/
double CBlob::Area()
{
	double area;
